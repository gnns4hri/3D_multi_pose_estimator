...
parser.add_argument('--load',  type=str, required=False, help="tch file to load the parameters from")
...
if __name__ == '__main__':
    ...
    if args.load:
        loaded = torch.load(args.load, map_location="cuda", weights_only=True)
        mlp.load_state_dict(loaded["model_state_dict"])
